    ...
    private static function catalogue(): array
    {
        return [
            ...
            'tracking' => [
                ...
                'Country' => static fn (Lead $l) => (string) $l->country,
                'Country Source' => static fn (Lead $l) => (string) $l->country_source,
                'IP Country' => static fn (Lead $l) => (string) $l->ip_country,
                'Browser Timezone' => static fn (Lead $l) => (string) $l->browser_timezone,
                'Browser Language' => static fn (Lead $l) => (string) $l->browser_language,
