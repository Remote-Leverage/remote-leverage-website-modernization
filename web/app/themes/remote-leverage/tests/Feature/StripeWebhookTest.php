...
describe('StripeWebhookController', function () {
    ...
    test('account.updated enables partner when payouts_enabled is true', function () {
        $partner = Partner::create([
            'name' => 'Stripe Partner 1',
    ...
    test('account.updated sets partner to pending when payouts_enabled is false', function () {
        $partner = Partner::create([
            'name' => 'Stripe Partner 2',
