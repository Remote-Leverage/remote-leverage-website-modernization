...
/**
 * Title: Full Page - Real Estate Virtual Assistants
 * Slug: remote-leverage/real-estate-virtual-assistants-full
 * Categories: remote-leverage
 * Description: The /real-estate-virtual-assistants/ role page. Hero and task cards come from the shared role map; everything below is the site-wide set.
 *
 ...
 */
?>
<?= RolePages::renderHero('real-estate-virtual-assistants') ?>
<?= RolePages::renderTalent('real-estate-virtual-assistants') ?>
