...
/**
 * Title: Full Page - Insurance Virtual Assistants
 * Slug: remote-leverage/insurance-virtual-assistants-full
 * Categories: remote-leverage
 * Description: The /insurance-virtual-assistants/ role page. Hero and task cards come from the shared role map; everything below is the site-wide set.
 *
 ...
 */
?>
<?= RolePages::renderHero('insurance-virtual-assistants') ?>
<?= RolePages::renderTalent('insurance-virtual-assistants') ?>
