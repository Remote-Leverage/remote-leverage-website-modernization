 ...
 * Slug: remote-leverage/ecommerce-virtual-assistants-full
 * Categories: remote-leverage
 * Description: The /ecommerce-virtual-assistants/ role page. Hero and task cards come from the shared role map; everything below is the site-wide set.
 *
 ...
 */
?>
<?= RolePages::renderHero('ecommerce-virtual-assistants') ?>
<?= RolePages::renderTalent('ecommerce-virtual-assistants') ?>
