        ...
        <section class="relative bg-bg-light pt-14 pb-4 overflow-hidden">
            ...
            <div class="relative z-10 max-w-[1380px] mx-auto px-6 lg:px-10 text-center">
                ...
                <div class="max-w-4xl mx-auto mb-9">
                    <p class="font-normal text-black text-[22px] sm:text-[24px] leading-[34px] tracking-[-0.015em] mb-2">
                    ...
                    <p class="font-normal text-black text-[22px] sm:text-[24px] leading-[34px] tracking-[-0.015em]">
                        We help companies hire exceptional remote talent across sales, marketing, operations, support, and
                ...
                <div class="flex flex-col gap-3 mb-20 sm:mb-24">
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-[38%_31%_31%] items-center">
                            ...
                            <div class="font-display text-base sm:text-[17px] font-bold text-black">Remote Leverage</div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                    ...
                    <div class="pt-16 pb-12 lg:pt-24 lg:pb-24 space-y-7 max-w-xl">
                        ...
                        <div class="space-y-4 text-[15px] sm:text-base leading-relaxed text-white/80">
                            <p>12-Month free replacement guarantee on any remote talent you hire through us to ensure you
                                have a perfect fit. You'll also have a dedicated manager to help you set up training,
                                performance tracking, and any other support you need.</p>
                            <p class="text-white">No contracts or commitments.</p>
                            <p>We get paid a flat hiring fee if you choose to hire a Virtual Assistant after interviewing
                                our applicants.</p>
                        </div>
                        <div class="pt-2">
                            <a href="#booking-footer"
                                ...
                                <span
                                    ...
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                                        <path d="M9 18l6-6-6-6" stroke="#fff" stroke-width="2.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </span>
                            </a>
