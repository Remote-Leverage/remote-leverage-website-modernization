<header x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-40 w-full bg-[#F4F6FC] border-b border-slate-200/60 transition-all duration-200">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-20">
      
      <!-- Brand Logo -->
      <div class="shrink-0">
        <a href="{{ home_url('/') }}" class="flex items-center gap-3 group focus:outline-none focus:ring-2 focus:ring-brand-purple focus:ring-offset-2 rounded-lg" aria-label="{{ $siteName ?? 'Remote Leverage' }}">
          <img 
      ...
      <div class="hidden lg:flex items-center gap-8 xl:gap-10">
          ...
          {!! wp_nav_menu([
            ...
            'fallback_cb' => function() {
              ...
              <ul class="flex items-center gap-7 xl:gap-9 text-[17px] font-display font-medium text-slate-900">
                <!-- Reviews Dropdown -->
                <li class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" @click.outside="open = false">
                  ...
                  <ul x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-1" class="absolute left-0 top-full mt-2 min-w-[280px] bg-white rounded-2xl p-2.5 shadow-xl border border-slate-100 z-50 flex flex-col gap-1" style="display: none;">
                    <li><a href="' . home_url('/reviews') . '" class="block px-4 py-2.5 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Testimonial Reviews</a></li>
                    <li><a href="' . home_url('/case-study/') . '" class="block px-4 py-2.5 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Case Studies</a></li>
                    <li><a href="' . home_url('/samples') . '" class="block px-4 py-2.5 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Sample Applicant Recordings</a></li>
                  </ul>
                </li>
                ...
                <li class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" @click.outside="open = false">
                  ...
                  <ul x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-1" class="absolute left-0 top-full mt-2 min-w-[320px] bg-white rounded-2xl p-2.5 shadow-xl border border-slate-100 z-50 flex flex-col gap-1 max-h-[480px] overflow-y-auto" style="display: none;">
                    <li><a href="' . home_url('/admin-virtual-assistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Admin Virtual Assistants</a></li>
                    <li><a href="' . home_url('/executive-virtual-assistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Executive Virtual Assistants</a></li>
                    <li><a href="' . home_url('/customer-support-virtual-assistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Customer Support Virtual Assistants</a></li>
                    <li><a href="' . home_url('/sales-virtual-assistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Sales Virtual Assistants</a></li>
                    <li><a href="' . home_url('/lead-generation-virtual-assistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Lead Generation Virtual Assistants</a></li>
                    <li><a href="' . home_url('/socialmediavirtualassistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Social Media Virtual Assistants</a></li>
                    <li><a href="' . home_url('/marketing-assistants-legacy/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Marketing Virtual Assistants</a></li>
                    <li><a href="' . home_url('/graphic-design-virtual-assistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Graphic Design Virtual Assistants</a></li>
                    <li><a href="' . home_url('/bookkeeping-accounting-virtual-assistants/') . '" class="block px-4 py-2 text-sm font-medium text-slate-800 hover:text-brand-purple hover:bg-slate-50 rounded-xl transition-colors">Bookkeeping / Accounting Virtual Assistants</a></li>
                  </ul>
                </li>

                <!-- Pricing Link -->
                <li>
                  <a href="' . home_url('/vapricing') . '" class="py-2 hover:text-brand-purple transition-colors">
                    Pricing
                  </a>
                </li>
              </ul>';
        ...
        >
          ...
          <svg class="w-5 h-5 text-black group-hover:translate-x-0.5 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  >
    <nav class="flex flex-col space-y-1">
      {!! wp_nav_menu([
        ...
        'fallback_cb' => function() {
          return '
          <a href="' . home_url('/reviews') . '" class="px-3 py-2 rounded-lg text-base font-semibold text-slate-800 hover:bg-slate-100">Reviews</a>
          <a href="' . home_url('/case-study/') . '" class="px-3 py-2 rounded-lg text-base font-semibold text-slate-800 hover:bg-slate-100">Case Studies</a>
          <a href="' . home_url('/admin-virtual-assistants/') . '" class="px-3 py-2 rounded-lg text-base font-semibold text-slate-800 hover:bg-slate-100">Virtual Assistant Roles</a>
          <a href="' . home_url('/vapricing') . '" class="px-3 py-2 rounded-lg text-base font-semibold text-slate-800 hover:bg-slate-100">Pricing</a>
          <a href="' . home_url('/samples') . '" class="px-3 py-2 rounded-lg text-base font-semibold text-slate-800 hover:bg-slate-100">Audio Samples</a>';
        }
      ]) !!}
    </nav>
