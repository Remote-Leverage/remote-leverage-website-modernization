    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-10">
        ...
        <p class="mt-3 text-base text-slate-600">
          Partner with Remote Leverage to deliver executive talent solutions to your clients while earning recurring commissions.
        </p>
      </div>

      {{-- Embed Reactive Partner Registration Form --}}
      <livewire:partner.partner-registration-form />
